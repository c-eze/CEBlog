...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CEBlog.Models.Blog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CEBlog.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CEBlog.Models.Reply", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CEBlog.Models.Comment", b =>
                {
                    ...
                    b.HasOne("CEBlog.Models.BlogUser", "Moderator")
                        .WithMany()
            ...
            modelBuilder.Entity("CEBlog.Models.Post", b =>
                {
                    ...
                    b.HasOne("CEBlog.Models.Blog", "Blog")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("CEBlog.Models.Reply", b =>
                {
                    ...
                    b.HasOne("CEBlog.Models.Comment", "Comment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CEBlog.Models.BlogUser", null)
                        .WithMany()
